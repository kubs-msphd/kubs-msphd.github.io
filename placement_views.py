...
def render_placements(context):
    ...
    return f'''{context['page_intro']('졸업생 진로','Graduate careers','졸업생 진로','Graduate careers','석사·박사 졸업생의 진출 분야와 학계·연구 동문을 전공별로 확인하실 수 있습니다.','Explore graduate career paths and academic and research alumni by field.')}
    ...
    <div class="outcomes-intro">{t('석사·박사 졸업생의 진출 분야','Where our graduates go','h2')}</div>
    <div class="outcome-panels">{render_outcome_panels(context)}</div>
    <section class="academic-section" id="academic-careers">{t('학계·연구 동문','Alumni in academia and research','h2')}
